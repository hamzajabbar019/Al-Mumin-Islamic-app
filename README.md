...
A modern Islamic companion app powered by Hamza Jabbar, built with React, Tailwind CSS, and Express.
...
This will install all required packages (React, Tailwind, Gemini SDK, etc.).
...
npm run build	Build production version (dist folder)
npm run lint	Check code for errors (TypeScript/ESLint)
📱 Mobile Testing (Pro Tip)

To test on your phone:

Connect your PC & phone to the same Wi-Fi
